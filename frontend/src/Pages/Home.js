...
import '../Components/CSS/Header.css'; // Correct path to CSS
import Header from '../Components/UI/Header'; // Correct path to Header component
import microphoneIcon from '../Images/Microphone.png'; // Correct path to image
